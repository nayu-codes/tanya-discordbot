...
#entire base code was generated by some unknown  website only the previous owner knows
...
if __name__ == '__main__':
    ...
    if not os.path.exists("config.json"):
        ...
        contents = {
          "BOT_TOKEN": "",
          "GLOBAL_PREFIX": "", #attach to before every command
          "GUILD_PREFIXES": {}, #same here for but guilds
          "UNIT_TEXT": "", #?
          "LOADED_COGS": [] #?
        }
...
async def info(ctx):
    ...
    embed.add_field(name="Coded by",value="9AMB Tech Support", inline=False)
